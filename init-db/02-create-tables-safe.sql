...
-- This script creates the complete database schema with duplicate prevention
...
-- Insert default data with duplicate prevention
INSERT INTO roles (name, description)
SELECT 'admin', 'ผู้ดูแลระบบ'
WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'admin');

INSERT INTO roles (name, description)
SELECT 'user', 'ผู้ใช้งานทั่วไป'
WHERE NOT EXISTS (SELECT 1 FROM roles WHERE name = 'user');

-- Insert default vehicle types
INSERT INTO vehicle_types (name, description)
SELECT 'รถบรรทุก 6 ล้อ', 'รถบรรทุกขนาด 6 ล้อ'
WHERE NOT EXISTS (SELECT 1 FROM vehicle_types WHERE name = 'รถบรรทุก 6 ล้อ');

INSERT INTO vehicle_types (name, description)
SELECT 'รถบรรทุก 10 ล้อ', 'รถบรรทุกขนาด 10 ล้อ'
WHERE NOT EXISTS (SELECT 1 FROM vehicle_types WHERE name = 'รถบรรทุก 10 ล้อ');

INSERT INTO vehicle_types (name, description)
SELECT 'รถบรรทุก 18 ล้อ', 'รถบรรทุกขนาด 18 ล้อ'
WHERE NOT EXISTS (SELECT 1 FROM vehicle_types WHERE name = 'รถบรรทุก 18 ล้อ');

INSERT INTO vehicle_types (name, description)
SELECT 'รถพ่วง', 'รถพ่วงขนส่ง'
WHERE NOT EXISTS (SELECT 1 FROM vehicle_types WHERE name = 'รถพ่วง');

INSERT INTO vehicle_types (name, description)
SELECT 'รถตู้', 'รถตู้ขนส่ง'
WHERE NOT EXISTS (SELECT 1 FROM vehicle_types WHERE name = 'รถตู้');

-- Insert default sugar types
INSERT INTO sugar_types (name, description)
SELECT 'น้ำตาลทรายขาว', 'น้ำตาลทรายขาวบริสุทธิ์'
WHERE NOT EXISTS (SELECT 1 FROM sugar_types WHERE name = 'น้ำตาลทรายขาว');

INSERT INTO sugar_types (name, description)
SELECT 'น้ำตาลทรายแดง', 'น้ำตาลทรายแดง'
WHERE NOT EXISTS (SELECT 1 FROM sugar_types WHERE name = 'น้ำตาลทรายแดง');

INSERT INTO sugar_types (name, description)
SELECT 'น้ำตาลทรายดิบ', 'น้ำตาลทรายดิบ'
WHERE NOT EXISTS (SELECT 1 FROM sugar_types WHERE name = 'น้ำตาลทรายดิบ');

INSERT INTO sugar_types (name, description)
SELECT 'น้ำตาลปี๊บ', 'น้ำตาลปี๊บ'
WHERE NOT EXISTS (SELECT 1 FROM sugar_types WHERE name = 'น้ำตาลปี๊บ');

INSERT INTO sugar_types (name, description)
SELECT 'น้ำตาลมะพร้าว', 'น้ำตาลมะพร้าว'
WHERE NOT EXISTS (SELECT 1 FROM sugar_types WHERE name = 'น้ำตาลมะพร้าว');
